...
void main()
{
  ...
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2(-3, -3)));
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2(-2, -3)));
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2(-1, -3)));
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2( 0, -3)));
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2( 1, -3)));
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2( 2, -3)));
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2( 3, -3)));
        
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2(-3, -2)));
  ...
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2(-3, -1)));
  ...
  f(csum, cmin, cmax, textureOffset(image, gl_FragCoord.xy, ivec2(-3,  0)));
